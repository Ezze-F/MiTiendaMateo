"""
URL configuration for p_tienda project.
...
urlpatterns = [
    ...
    path('caja/', include(('a_cajas.urls', 'a_cajas'), namespace='a_cajas')),
    path('', include('a_login.urls')),
    path('pagina/', include('a_inicio.urls', namespace='a_inicio')),
